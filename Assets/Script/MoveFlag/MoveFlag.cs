...
public class MoveFlag : MonoBehaviour
{
    ...
    void SetDest(Vector3 from, Vector3 dest)
    {
        ...
        Line.transform.localRotation = Quaternion.FromToRotation(vec, from) * Quaternion.Euler(90,0,0);
        //vec.normalized
    }
